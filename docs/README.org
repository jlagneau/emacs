...
Create a helper function to concatenate path no matter if the entries end with a directory separator or not.
...
#+begin_src emacs-lisp
  (let ((backup-dir (lec/concat-path lec/var-directory "backups"))
        (auto-saves-dir (lec/concat-path lec/var-directory "auto-saves")))
    (dolist (dir (list backup-dir auto-saves-dir))
      (when (not (file-directory-p dir))
        (make-directory dir t)))
    (setq backup-directory-alist `(("." . ,backup-dir))
          auto-save-file-name-transforms `((".*" ,auto-saves-dir t))
          auto-save-list-file-prefix (lec/concat-path auto-saves-dir ".saves-")
...
#+begin_src emacs-lisp
  (use-package recentf
    ...
    :custom
    (recentf-save-file (lec/concat-path lec/var-directory "recentf"))
  ...
  (use-package dashboard
    ...
    (setq dashboard-center-content t
          ...
          `(((,nil "Benchmark" "Show benchmark tree" (lambda (&rest _) (benchmark-init/show-durations-tree)))
             ...
             (,nil "Reload configuration" "Reload GNU/Emacs configuration" (lambda (&rest _) (load-file (lec/concat-path user-emacs-directory "init.el"))) warning))
...
#+begin_src emacs-lisp
  (defvar lec/--undo-history-directory (lec/concat-path lec/var-directory "undos/")
...
#+begin_src emacs-lisp
  (use-package php-mode
    ...
    (lsp-intelephense-global-storage-path
     (lec/concat-path lec/var-directory "intelephense"))
    (lsp-intelephense-licence-key
     (lec/--file-contents (lec/concat-path
